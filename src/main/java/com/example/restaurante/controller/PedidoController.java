...
public class PedidoController {
    ...
    @GetMapping("/{id}")
    @ResponseStatus(HttpStatus.FOUND)
    public PedidoResponse listar(@PathVariable Long id){
    ...
    @ResponseStatus(HttpStatus.CREATED)
    public PedidoItemResponse adicionarItens(@PathVariable Long pedidoId, @RequestBody PedidoItemRequest request){
    ...
    public void pagar(@PathVariable Long pedidoId, @RequestBody String formaPagamento){
